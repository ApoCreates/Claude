...
const BANK: Record<string, KEntry[]> = {
  ...
  geography: [
    ...
    e(6, ["what is the water cycle", "دورة الماء", "دورة المياه"], "Water **evaporates** from seas, **condenses** into clouds, **falls** as rain or snow, and **flows** back to the sea — a loop powered by the Sun.", "الماء **يتبخّر** من البحار، و**يتكاثف** غيوماً، و**يهطل** مطراً أو ثلجاً، و**يجري** عائداً للبحر — دورة تحرّكها الشمس."),
  ...
  ai: [
    ...
    e(6, ["what is artificial intelligence", "what is ai", "what is machine learning", "ما هو الذكاء الاصطناعي", "تعلم الالة"], "AI teaches computers to do things that usually need thinking — like recognising a cat. Most modern AI **learns from thousands of examples** instead of fixed rules; that's *machine learning*.", "الذكاء الاصطناعي يعلّم الحواسيب أداء مهام تحتاج تفكيراً — كتمييز قطة. ومعظمه الحديث **يتعلّم من آلاف الأمثلة** بدل القواعد الثابتة؛ وهذا *تعلّم الآلة*."),
    e(9, ["what is a neural network", "ما هي الشبكة العصبية"], "A neural network is layers of simple ‘neurons’ that pass signals forward. Training nudges the connections until the whole network maps inputs to the right outputs.", "الشبكة العصبية طبقات من «خلايا» بسيطة تمرّر الإشارات. يعدّل التدريب الوصلات حتى تربط الشبكة المدخلات بالمخرجات الصحيحة."),
  ],
  gaming: [
  ...
  entrepreneurship: [
    e(3, ["what is money for", "why do we use money", "لماذا نستخدم المال"], "Money is a **fair way to trade**. Instead of swapping a goat for bread, we agree on a price in money, so everyone can buy and sell easily.", "المال **طريقة عادلة للمقايضة**. بدل مبادلة ماعز بخبز، نتّفق على سعر بالمال، فيسهل على الجميع البيع والشراء."),
    e(5, ["what is profit", "ما هو الربح"], "Profit is what's left after costs: **Profit = Sales − Costs**. Sell lemonade for 10 and it costs you 6, your profit is 4 per cup. If costs beat sales, that's a loss.", "الربح ما يتبقّى بعد التكاليف: **الربح = المبيعات − التكاليف**. تبيع العصير بـ١٠ ويكلّفك ٦، فربحك ٤ للكوب. وإن زادت التكاليف فتلك خسارة."),
    e(8, ["what is a business plan", "ما هي خطة العمل"], "A business plan answers four questions: **who's the customer, what problem you solve, how you make money, and what it costs to start**. It's a map before you spend.", "خطة العمل تجيب أربعة أسئلة: **من العميل، وأي مشكلة تحلّ، وكيف تربح، وكم تكلفة البدء**. إنها خريطة قبل الإنفاق."),
  ],
  leadership: [
